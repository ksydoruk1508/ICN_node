...
function install_node {
    ...
    echo -e "${GREEN}Установка ноды ICN запущена в фоновом режиме. Логи установки находятся в файле icn_install.log. Убедитесь, что порт доступен для использования.${NC}"
}
